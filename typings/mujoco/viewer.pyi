...
class Handle:
    ...
    def set_figures(
        ...
        viewports_figures: typing.Union[
            typing.Tuple[mujoco._structs.MjrRect, mujoco._structs.MjvFigure],
            typing.List[
                typing.Tuple[mujoco._structs.MjrRect, mujoco._structs.MjvFigure]
            ],
        ],
    ...
    def set_images(
        ...
        viewports_images: typing.Union[
            typing.Tuple[mujoco._structs.MjrRect, numpy.ndarray],
            typing.List[typing.Tuple[mujoco._structs.MjrRect, numpy.ndarray]],
        ],
    ):
        """
...
def _launch_internal(
    ...
    *,
    ...
    loader: typing.Union[
        typing.Callable[
            [], typing.Tuple[mujoco._structs.MjModel, mujoco._structs.MjData]
        ],
        typing.Callable[
            [], typing.Tuple[mujoco._structs.MjModel, mujoco._structs.MjData, str]
        ],
